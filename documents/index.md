...
**Izvor istine** za dokumentaciju:
- `documents/index.md` je **ulazna točka**.
- Svi moduli/linkovi ispod ovog indexa su **važeći**.
- Sve izvan `documents/` ili u `documents/_archive/` je **povijesno** i **ne koristi se za razvoj**.

Glavni ulaz u dokumentaciju.

## Pregled
- [Pregled](overview/overview.md)
- [Brzi početak](overview/quick-start.md)
- [Dijagram toka](overview/flow-diagram.md)
...
## Zalihe
- [FIFO](stock/stock-fifo.md)
- [Rezervacije](stock/stock-reservations.md)
- [Inventura](stock/inventura.md)
...
## Admin
- [Admin iskustvo](admin/admin-ux.md)
...
## Dijagrami
- [Mermaid dijagrami](diagrams/mermaid-diagrams.md)

## Budućnost
- [Budući rad](future/future-work.md)
